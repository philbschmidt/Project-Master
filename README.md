...
Project Master stores your projects and categories in VS Code's global storage directory:
- **Windows**: `%APPDATA%\Code\User\globalStorage\philbschmidt.project-master\`
- **macOS**: `~/Library/Application Support/Code/User/globalStorage/philbschmidt.project-master/`
- **Linux**: `~/.config/Code/User/globalStorage/philbschmidt.project-master/`
...
- **Rate & Review**: [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=philbschmidt.project-master)